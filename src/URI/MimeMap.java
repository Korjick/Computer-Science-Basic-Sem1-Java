...
public class MimeMap {
    ...
    private HashMap<String, String> s_mapMimeTypes;
    ...
    public int size() {
        return s_mapMimeTypes.size();
    }

    public boolean isEmpty() {
        return s_mapMimeTypes.isEmpty();
    }

    public String get(Object key) {
        return s_mapMimeTypes.get(key);
    }

    public boolean containsKey(Object key) {
        return s_mapMimeTypes.containsKey(key);
    }

    public String put(String key, String value) {
        return s_mapMimeTypes.put(key, value);
    }

    public void putAll(Map<? extends String, ? extends String> m) {
        s_mapMimeTypes.putAll(m);
    }

    public String remove(Object key) {
        return s_mapMimeTypes.remove(key);
    }

    public void clear() {
        s_mapMimeTypes.clear();
    }

    public boolean containsValue(Object value) {
        return s_mapMimeTypes.containsValue(value);
    }

    public Set<String> keySet() {
        return s_mapMimeTypes.keySet();
    }

    public Collection<String> values() {
        return s_mapMimeTypes.values();
    }

    public Set<Map.Entry<String, String>> entrySet() {
        return s_mapMimeTypes.entrySet();
    }

    public String getOrDefault(Object key, String defaultValue) {
        return s_mapMimeTypes.getOrDefault(key, defaultValue);
    }

    public String putIfAbsent(String key, String value) {
        return s_mapMimeTypes.putIfAbsent(key, value);
    }

    public boolean remove(Object key, Object value) {
        return s_mapMimeTypes.remove(key, value);
    }

    public boolean replace(String key, String oldValue, String newValue) {
        return s_mapMimeTypes.replace(key, oldValue, newValue);
    }

    public String replace(String key, String value) {
        return s_mapMimeTypes.replace(key, value);
    }

    public String computeIfAbsent(String key, Function<? super String, ? extends String> mappingFunction) {
        return s_mapMimeTypes.computeIfAbsent(key, mappingFunction);
    }

    public String computeIfPresent(String key, BiFunction<? super String, ? super String, ? extends String> remappingFunction) {
        return s_mapMimeTypes.computeIfPresent(key, remappingFunction);
    }

    public String compute(String key, BiFunction<? super String, ? super String, ? extends String> remappingFunction) {
        return s_mapMimeTypes.compute(key, remappingFunction);
    }

    public String merge(String key, String value, BiFunction<? super String, ? super String, ? extends String> remappingFunction) {
        return s_mapMimeTypes.merge(key, value, remappingFunction);
    }

    public void forEach(BiConsumer<? super String, ? super String> action) {
        s_mapMimeTypes.forEach(action);
    }

    public void replaceAll(BiFunction<? super String, ? super String, ? extends String> function) {
        s_mapMimeTypes.replaceAll(function);
    }
}
